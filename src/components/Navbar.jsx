...
const RESUME_LINK =
  'https://drive.google.com/file/d/1-llREzHkJjQ964BguAaC2WtJWXIms1mW/view?usp=drive_link';
...
const Navbar = () => {
  ...
  return (
    <div className={style.navbar_container}>
      {/* FIX: use style.fixed for CSS modules */}
        ...
        >
          ...
          <li>
            <motion.a
              ...
              target="_blank"
              rel="noreferrer"
              className={`${style.resume_btn} ${style.mobile_resume_btn}`}
